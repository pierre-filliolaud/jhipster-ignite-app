...
class ProductGatlingTest extends Simulation {
    ...
    val authorization_header = "Basic " + Base64.getEncoder.encodeToString("ignitejhipsterapp:my-secret-token-to-change-in-production".getBytes(StandardCharsets.UTF_8))
    ...
    val scn = scenario("Test the Product entity")
        ...
        .formParam("client_id", "ignitejhipsterapp")
